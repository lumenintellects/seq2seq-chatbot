...
LOG_BASE_FILENAME = "5_evaluate_model_with_attention"
...
# ==========================
    ...
    while get_setting_evaluation_loop_continue():
        ...
        if get_setting_evaluation_reload_model_in_loop():
            ...
            if not load_latest_model_state(model_with_attention, path_model, logger):
        ...
        subset_loss, subset_bleu = evaluate_model(model_with_attention, test_loader, criterion, sp_model, device)
